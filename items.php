		...
		<div class="col-md-9 item-info">
			...
			<ul class="list-unstyled">
				...
				<li>
					...
					<span>Category</span> : <a href="categories.php?pageid=<?php echo $item['category_id'] ?>"><?php echo $item['category_name'] ?></a>
				</li>
				<li>
					<i class="fa fa-user fa-fw"></i>
					<span>Added By</span> : <a href="#"><?php echo $item['posted_by'] ?></a>
				</li>
				<li class="tags-items">
					<i class="fa fa-user fa-fw"></i>
					<span>Tags</span> : 
